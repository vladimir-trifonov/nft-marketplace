...
export interface NFTEnumerableInterface extends utils.Interface {
  contractName: "NFTEnumerable";
  functions: {
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "fetchTokensIdsBatch(address,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "fetchTokensIdsBatch",
...
export interface NFTEnumerable extends BaseContract {
  contractName: "NFTEnumerable";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NFTEnumerableInterface;
